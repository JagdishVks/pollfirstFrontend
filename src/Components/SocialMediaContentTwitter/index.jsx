...
const SocialMediaContentTwitter = ({ leaderName }) => {
      ...
      try {
        ...
        if (leaderName1) {
          const newsResponse = await axios.get(
            `http://localhost:5196/api/KnowledgeCenter/TwitterArticlesByLeaderName?leaderName=${encodeURIComponent(
              leaderName1
            )}`
          );
...
export default SocialMediaContentTwitter;
