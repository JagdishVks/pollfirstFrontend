...
const IssuesCard = () => {
  ...
  return (
   <div className=" w-full shadow-md  shadow-black-200  rounded-xl border-2 border-black bg-[#ffffff] px-2 py-1  flex ">
      ...
      <h1 className='font-istokweb w-[22%]   2xl:text-[18px] text-[16px] text-[#03393D]'>{expand==true?splitStringIntoChunks("#AkashAnand,Akash+Anand+BSPsfkjbkfeiwugfeiufifiufiuewu, ") :truncateString("Akash+Anand+BSP, आकाश+आनंद+बसपा")}</h1>
      <h1 className='font-istokweb w-[23%] 2xl:text-[18px] text-[16px] text-[#03393D]'>{expand==true?splitStringIntoChunks("#AkashAnand,Akash+Anand+BSPsfkjbkfeiwugfeiufifiufiuewu, ") :truncateString("Akash+Anand+BSP, आकाश+आनंद+बसपा")}</h1>
      <h1 className='font-istokweb w-[20%]  2xl:text-[18px] text-[16px] text-[#03393D]'>{expand==true?splitStringIntoChunks("#AkashAnand,Akash+Anand+BSPsfkjbkfeiwugfeiufifiufiuewu, ") :truncateString("Akash+Anand+BSP, आकाश+आनंद+बसपा")}</h1>
