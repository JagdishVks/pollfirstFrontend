...
const SocialMediaContentFacebook = ({leaderName}) => {
      ...
      try {
        ...
        if (leaderName1) {
          const newsResponse = await axios.get(
            `http://localhost:5196/api/KnowledgeCenter/FacebookArticlesByLeaderName?leaderName=${encodeURIComponent(
              leaderName1
            )}`
          );
...
export default SocialMediaContentFacebook;
